  ...
  public <T> T getController(String controller){
    ...
    if (ret == null){
      if (org.cruxframework.crux.core.client.utils.StringUtils.unsafeEquals(controller, "mainController")){
        phonepay.client.MainController_ControllerProxy __cont  = new phonepay.client.MainController_ControllerProxy(this.view);
        __cont.screen = iocContainer.getphonepay_client_MainController_MainView(org.cruxframework.crux.core.client.ioc.IoCResource.Scope.LOCAL, null);
